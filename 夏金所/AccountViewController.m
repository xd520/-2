...
- (void)buttonClicked:(UITouch *)sender
{
     UIView *view = [sender view];
    NSString *imagePath = [[NSBundle mainBundle] pathForResource:@"qrcode_icon"  ofType:@"png"];
    ...
    id<ISSContent> publishContent = [ShareSDK content:@"分享内容"
                                       defaultContent:@"默认分享内容，没内容时显示"
                                                ...
                                                title:@"厦金所"
                                                  url:@"https://www.fyfae.com"
                                          description:@"这是一条测试信息"
                                            mediaType:SSPublishContentMediaTypeNews];
    
    
    //自定义菜单项
    id<ISSShareActionSheetItem> item1 = [ShareSDK shareActionSheetItemWithTitle: @"二维码"
                                                                           icon:[UIImage imageNamed:@"qrcode_icon.png"]
                                                                   clickHandler:^{
